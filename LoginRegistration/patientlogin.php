...
<head>
    ...
    <link rel="stylesheet" href="/MentalHealthCare/css/style.css">
</head>
<body>
    <style>
        form{
        ...
        <div class="contentBx">
            ...
            <div class="formBx">
                ...
                <form action="login.php" class="form_design" method="post" >
                    ...
                    <button class="submit-btn"><a href="\MentalHealthCare\LoginRegistration\patientregi.php">Create an account</a></button>
                </form>
            </div>
        </div>
    </section>
